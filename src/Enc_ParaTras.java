...
class Enc_ParaTras {
	...
	public Enc_ParaTras(String a, String t) {
	...
	public static void main(String[] args) {
		...
		ask = "e";
		tell = "a&b->c;c&d->e;a;d;";
		System.out.println(new Enc_ParaTras(ask, tell).execute());
	...
	// method which calls the main bcentails() method and returns output back to
	// iengine
	...
	public static ArrayList<String> getPremises(String clause) {
		...
		System.out.println("XXXX" + temp.toString());
		return temp;
	}
